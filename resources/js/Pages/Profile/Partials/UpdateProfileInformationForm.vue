...
<template>
    <section class="">
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="flex space-y-3">
            <div class="w-1/2">
            ...
            <div class="w-1/3">
                <div class="h-60 w-full" v-if="form.profile_img && !previewProfilePhoto">
                    <img :src="form.profile_img" alt="">
                </div>
                <div class="" v-else-if="!form.profile_img || !previewProfilePhoto">
                    No Profile Image
                </div>
                <div class="h-60 w-full" v-if="previewProfilePhoto">
                    <img :src="previewProfilePhoto" alt="" class="object-cover w-full h-full rounded">
                </div>
            </div>
        </form>
    </section>
