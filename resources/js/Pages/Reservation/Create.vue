      ...
      <div class="mb-3">
        ...
        <div class="gap-x-3 flex mb-2 [&>div]:w-60">
          <div class="flex flex-col">
            ...
            <MultiSelect v-model="reservationForm.room_id" :options="rooms" optionLabel="room_number" optionValue="id" filter placeholder="Select rooms"
...
<script setup>
  ...
  function submitForm() {
    reservationForm.post("/admin/reservations", {
