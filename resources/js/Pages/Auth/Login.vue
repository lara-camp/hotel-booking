...
<template>
  ...
  <form class="" @submit.prevent="submit">
    ...
    <div class="flex flex-col mb-4">
      <Password v-model="form.password" toggle-mask :feedback="false" id="current_password" size="small" class="w-full"
        ref="currentPasswordInput" placeholder="Password" required />
