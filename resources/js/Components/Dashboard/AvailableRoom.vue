<template>
  <div class="">
    <h1 class="mb-6 text-2xl font-semibold">Today's Available Rooms</h1>
...
<script setup>
  ...
  const mutatedAvailableRoomTypes = computed(() => ({ labels: Object.keys(props.availableRooms), data: Object.values(props.availableRooms) }))
