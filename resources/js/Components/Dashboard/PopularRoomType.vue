<template>
    <div class="">
        <h1 class="mb-6 text-2xl font-semibold">Popular Room Types</h1>
...
<script setup>
    ...
    const mutatedAvailableRoomTypes = computed(() => ({ labels: Object.keys(props.popularRoomTypes), data: Object.values(props.popularRoomTypes) }))
